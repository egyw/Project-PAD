...
namespace POS
{
    public partial class FormAdmin : Form
    {
        ...
        public FormAdmin(string name)
        {
            ...
            btnUpd.Location = new Point((dgvUsers.Width + dgvUsers.Location.X) - btnUpd.Width, btnY + btnUpd.Height);
            btnAddUser.Location = new Point((dgvUsers.Width + dgvUsers.Location.X) - btnAddUser.Width, btnY);
            btnDelete.Location = new Point((dgvUsers.Width + dgvUsers.Location.X) - btnDelete.Width, btnY + btnUpd.Height * 3);
            btnEditUser.Location = new Point((dgvUsers.Width + dgvUsers.Location.X) - btnEditUser.Width, btnY + btnUpd.Height * 2);
            ...
            btnAddProducts.Location = new Point((dgvProducts.Width + dgvProducts.Location.X) - btnUpdateProduct.Width, btnYProducts);
            btnUpdateProduct.Location = new Point(btnAddProducts.Location.X, btnYProducts + btnUpdateProduct.Height);
            btnEditProduct.Location = new Point(btnAddProducts.Location.X, btnYProducts + btnUpdateProduct.Height * 2);
            btnDeleteProduct.Location = new Point(btnAddProducts.Location.X, btnYProducts + btnUpdateProduct.Height * 3);
